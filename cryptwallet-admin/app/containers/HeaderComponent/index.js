...
import userLogo from 'images/user/user1.jpg';
...
const HeaderComponent = props => {
  ...
  try {
    ...
    console.log('un able to read user');
  }
      ...
      <header className="headerArea">
        ...
        <div className="headerRight">
          <div className="notification">
            <span onClick={handleNotifyToggle} className="notificationWrap">
              <img src={notificationIcon} alt="Notification" />
              <span component="span" className="popupShow">
                {notfications.length}
              </span>
            </span>
            <Menu
            ...
            >
              <li className="notificationList">
                <h5>
                  {props.intl.formatMessage({ ...messages.notification })}
                  <span>
                ...
                <Button className="seeAll" component={Link} to="/">
                  {props.intl.formatMessage({ ...messages.seeAll })}
                </Button>
              </li>
            </Menu>
          </div>
          ...
          <div className="shortProfile">
            ...
            >
              ...
              <i className={profile ? 'fa fa-angle-up' : 'fa fa-angle-down'} />
            </span>
            <Popper
                  ...
                  <Paper>
                    <ClickAwayListener onClickAway={profileHandleClose}>
                      <ul className="profileManu">
                        ...
                        <li>
                          <Button component={Link} to="/general-settings">
                            {props.intl.formatMessage({
                              ...messages.settings,
                            })}
                          </Button>{' '}
                        ...
                        <li>
                          <Button component={Link} onClick={resetData} to="/">
