...
class ForgotPasswordPage extends Component {
  ...
  validationPropertyChangePassword = event => {
    ...
    const Obj = { [event.target.name]: event.target.value };
    const schema = {
      [event.target.name]: this.schemaChangePassword[event.target.name],
    };
    const { error } = Joi.validate(Obj, schema);
    return error ? error.details[0].message : null;
  };
          ...
          <Grid className="container" container>
            <Grid item lg={6} xs={12}>
              <Grid className="accountImage">
                ...
                <p>Manage, Users and wallets with ultranote cloud wallet.</p>
              </Grid>
            </Grid>
            <Grid item lg={6} xs={12}>
              <Grid className="accountContent">
                ...
                <Typography className="text" paragraph>
                  Enter email address to request a password reset.
                </Typography>
