...
const API_KEY = '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';
...
exports.post_admin_forgot_password = async (req, res, next) => {
 ...
 console.log(link);
  ...
  const emailsend  =   {
    from: 'dasarijit727@gmail.com', // sender address
    to: `${email}`, // list of receivers
    subject: "Reset Password", // Subject line
    text: "Reset Your password", // plain text body
    html: `<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
    <head> 
     <meta charset="UTF-8"> 
  ...
  sgMail.send(emailsend).then(response =>    
    res.status(200).json({
     response:response, 
...
try {
 ...
 sgMail.setApiKey(API_KEY); 
  // const data =  '<img src="'+newfinalhtml+'"  width="500" height="600">';
  // console.log(data); 
  const emailsend  =   {
    from: 'dasarijit727@gmail.com', // sender address
    to: `${email}`, // list of receivers
    subject: "2FA Auth Google Authenticator", // Subject line
