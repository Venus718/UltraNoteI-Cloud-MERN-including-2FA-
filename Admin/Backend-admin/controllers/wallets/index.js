...
const Wallet = require('../../models/wallet');
 const xuni = new XUNI(process.env.XUNI_HOST || "http://127.0.0.1", process.env.XUNI_PORT || "9050");
  const UltraNote = require('../../helpers/ultranote');
  const ultranote = new UltraNote(process.env.XUNI_HOST || "http://127.0.0.1", process.env.XUNI_PORT || "9050" );
