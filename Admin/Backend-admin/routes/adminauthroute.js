...
router.post("/updatepassword",routeverivication,AdminauthController.post_update_password_set);
router.post("/updateprofile",routeverivication,upload.single('userImage'),AdminauthController.post_update_profile_details);
router.get("/profiledetails", routeverivication , AdminauthController.gets_users_all_details);
router.post("/signup",  upload.single('userImage') , AdminauthController.post_adminregister);
...
router.get('/reset-password/:id/:token',AdminauthController.get_admin_reset_password);
router.post('/reset-password/:id/:token',AdminauthController.post_admin_reset_password);
