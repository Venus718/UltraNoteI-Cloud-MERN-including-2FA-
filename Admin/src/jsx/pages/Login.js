...
const Login = (props) => {
  ...
  const submitHandler = (e) => {
    ...
    .then(res => {
      ...
      setInputValues({ ...inputValues,error: "Invalid Email Or Password"})
              ...
              <div className="row no-gutters">
                <div className="col-xl-12">
                  <div className="auth-form">
                    ...
                    {inputValues.error != null && <p style={{margin:"0px  110px",color:"#ffffff"}}>{inputValues.error}</p> }
                     ...
                     {errors.email && errors.email.type === "required" && <span>Email is required</span>}
                      ...
                      <div style={{marginTop:'25px'}} className="text-center">
                       <Link to="/googleauthicator"><button
                          type="button"
                          className="btn  btn-block"
                          
                          style={{backgroundColor:'#b4fee7', color:'black'}}
                        >
