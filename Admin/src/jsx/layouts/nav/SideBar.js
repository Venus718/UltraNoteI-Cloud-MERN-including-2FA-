...
const SideBar = ( {userProfileData} ) => {
  ...
  return (
    ...
    >
      ...
      { userProfileData ?
			<h5 className="mb-0 fs-20 text-black "><span className="font-w400">Hello,</span> {userProfileData.firstname}</h5>
       :
       <h5 className="mb-0 fs-20 text-black "><span className="font-w400">Hello,</span> Steve</h5> 
        }
     { userProfileData ?
      ...
      <p className="mb-0 fs-14 font-w400">steve@email.com</p>
        ...
        <MM className="metismenu" id="menu">
          <li className={`${deshBoard.includes(path) ? "mm-active" : ""}`}>
            ...
            <ul >
              <li><Link className={`${path === "" ? "mm-active" : ""}`} to="/dashboard">  Dashboard </Link></li>
          ...
          <li className={`${plugins.includes(path) ? "mm-active" : ""}`}>
				<Link className="has-arrow ai-icon" to="#" >
					<i className="flaticon-073-settings"></i><span className="nav-text">Settings</span>
				</Link>
       </li>
        </MM>
		<div className="copyright">
			<p><strong>Ultran Note</strong> © 2021 All Rights Reserved</p>
			<p className="fs-12">Made with <span className="heart"></span> by Ultran Note</p>
		</div>
      </PerfectScrollbar>
    </div>
  );
